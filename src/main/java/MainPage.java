...
public class MainPage {
    ...
    /*
    //Page Factory and annotations
    @FindBy(xpath = "//a[@class='HeaderMenu-link no-underline mr-3']"); //@FindBy annotation, locator for Sign in button
    private WebElement signInButton;
    @FindBy(xpath = "//a[@class='HeaderMenu-link d-inline-block no-underline border border-gray-dark rounded-1 px-2 py-1']"); //Sign up button
    private WebElement signUpButton;
    @FindBy(xpath = "//*[@id='user[login]']"); //locator for Username field
    private WebElement usernameField;
    @FindBy(xpath = "//*[@id='user[email]']"); //locator for Email field
    private WebElement emailField;
    @FindBy(xpath = "//*[@id='user[password]']"); //locator for Password field
    private WebElement passwordField;
    @FindBy(xpath = "//button[text()='Sign up for free']"); //locator for Sign up for free button
